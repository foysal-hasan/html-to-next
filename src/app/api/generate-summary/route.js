...
export async function POST(request) {
  try {
    ...
    // Summarize and translate to English
      ...
      messages: [
        {
          role: 'system',
          content:
            'You are a summarizer that always returns the result in English, even if the original text is in another language. Provide a short, clear summary of the key points.',
        },
        {
          role: 'user',
          content: content,
