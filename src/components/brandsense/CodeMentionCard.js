const CodeMentionCard = ({ url, date, mention }) => {
    // Determine button text based on the URL
    const buttonText = url.includes("gist.github.com") ? "View gist" : "View paste";
    ...
    return (
      <div className="flex gap-4 bg-[#111518] px-4 py-3 justify-between">
        <div className="flex flex-1 flex-col justify-center">
          ...
          <p className="text-[#9dabb9] text-sm font-normal leading-normal">Date: {date}</p>
