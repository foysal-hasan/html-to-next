    ...
    <header className="relative  px-4 py-3 md:px-6 lg:px-10">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 md:gap-8">
          ...
          <BrandsenseNavLink />
            <Link className="text-white text-sm font-medium leading-normal hover:text-gray-300 transition-colors" href="#">Technology</Link>
            <Link className="text-white text-sm font-medium leading-normal hover:text-gray-300 transition-colors" href="#">Business</Link>
            <Link className="text-white text-sm font-medium leading-normal hover:text-gray-300 transition-colors" href="#">Design</Link>
            <Link className="text-white text-sm font-medium leading-normal hover:text-gray-300 transition-colors" href="#">Culture</Link>
            <Link className="text-white text-sm font-medium leading-normal hover:text-gray-300 transition-colors" href="#">Science</Link>
            <Link className="text-white text-sm font-medium leading-normal hover:text-gray-300 transition-colors" href="#">Politics</Link>
          </nav>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          {/* User Profile */}
          <div className="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-8 md:size-10"
            style={{
