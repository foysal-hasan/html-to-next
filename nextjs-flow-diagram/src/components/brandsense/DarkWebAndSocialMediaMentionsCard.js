...
const DarkWebAndSocialMediaMentionsCard = ({
  link,
  date,
  content,
  risk,
  ...
  return (
    ...
    >
      ...
      <div className="shrink-0">
        <button
          className={`flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-8 px-4 bg-[#283139] text-white text-sm font-medium leading-normal w-fit ${getRiskClass(
            risk,
          )}`}
        >
